...
import { db, ensureDefaultTocRules } from '../db';
...
describe('db', () => {
  ...
  it('ensureDefaultTocRules populates rules on empty DB', async () => {
  ...
  it('ensureDefaultTocRules does not duplicate rules', async () => {
    await ensureDefaultTocRules();
